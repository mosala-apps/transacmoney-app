  ...
  return {
    ...
    validateIdentifier: (value: any) => {
      ...
      if (emailPattern.test(value)) {
        ...
        return true;
      } else if (value.length >= 0 && value.length <= 3) { // Nom d'utilisateur simple
        return true;
      }
      return "Veuillez entrer un email, numéro de téléphone ou nom d'utilisateur valide";
    },
